...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.arkgenesisascendedpart1.wiki'
  const path = '/about'

  return {
    title: 'About ARK Genesis Ascended Part 1 Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about ARK Genesis Ascended Part 1 Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the ARK Genesis Ascended Part 1 Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'ARK Genesis Ascended Part 1 Wiki',
      title: 'About ARK Genesis Ascended Part 1 Wiki',
      description: 'Learn about our mission to provide the best ARK Genesis Ascended Part 1 game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          alt: 'ARK Genesis Ascended Part 1 Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About ARK Genesis Ascended Part 1 Wiki',
      description: 'Learn about our mission to provide the best ARK Genesis Ascended Part 1 game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About ARK Genesis Ascended Part 1 Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for ARK Genesis Ascended Part 1
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to ARK Genesis Ascended Part 1 Wiki</h2>
            <p>
              ARK Genesis Ascended Part 1 Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "ARK Genesis Ascended Part 1". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              ARK Genesis Ascended Part 1 Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower ARK Genesis Ascended Part 1 players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision ARK Genesis Ascended Part 1 Wiki as the <strong>go-to destination</strong> for every ARK Genesis Ascended Part 1 player seeking
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Missions & Hexagon Guides</h3>
              <p className="text-slate-300">
                HLN-A mission walkthroughs, Hexagon reward routes, and biome-specific strategies
                to help you progress through the Genesis simulation.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Explore every corner of the Genesis simulation safely.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Step-by-step guides to unlock achievements in the game.
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Learn how to thrive in the sci-fi survival sandbox world.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Content available in multiple languages including English, German, Spanish,
                and French.
              </p>
            </div>
          </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ARK Genesis Ascended Part 1 Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ARK Genesis Ascended Part 1 Wiki is maintained by a dedicated team of passionate gamers and developers who love
              ARK Genesis Ascended Part 1 as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of ARK Genesis Ascended Part 1 mechanics and strategies</li>
            ...
            <p className="text-slate-400 italic text-sm">
              Surviving the Genesis simulation, one biome at a time.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>ARK Genesis Ascended Part 1 Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with Studio Wildcard, the developers of ARK or any official entities.
            </p>
            <p>
            ...
            <p>
              ARK Genesis Ascended Part 1 Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@arkgenesisascendedpart1.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@arkgenesisascendedpart1.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@arkgenesisascendedpart1.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@arkgenesisascendedpart1.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and ARK Genesis Ascended Part 1 news.
