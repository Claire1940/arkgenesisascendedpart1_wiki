...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - ARK Genesis Ascended Part 1 Wiki",
    description: "Read the Terms of Service for ARK Genesis Ascended Part 1 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - ARK Genesis Ascended Part 1 Wiki",
      description: "Terms and conditions for using ARK Genesis Ascended Part 1 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using ARK Genesis Ascended Part 1 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using ARK Genesis Ascended Part 1 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and ARK Genesis Ascended Part 1 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              ARK Genesis Ascended Part 1 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "ARK Genesis Ascended Part 1". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Missions, biomes, taming, and boss guides</li>
            ...
            <p>
              <strong>Important:</strong> ARK Genesis Ascended Part 1 Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of ARK Genesis Ascended Part 1. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by ARK Genesis Ascended Part 1 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or Studio Wildcard, the developers of ARK. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ARK GENESIS ASCENDED PART 1 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and ARK Genesis Ascended Part 1 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@arkgenesisascendedpart1.wiki</a>
            </p>
            <p>
