...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - ARK Genesis Ascended Part 1 Wiki',
    description: 'Copyright and intellectual property information for ARK Genesis Ascended Part 1 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - ARK Genesis Ascended Part 1 Wiki',
      description: 'Copyright and intellectual property information for ARK Genesis Ascended Part 1 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 ARK Genesis Ascended Part 1 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of ARK Genesis Ascended Part 1 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              ARK Genesis Ascended Part 1 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Studio Wildcard</strong> - Creators of the ARK Genesis Ascended Part 1 game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>ARK Genesis Ascended Part 1</strong> - Trademark of the game developers</li>
              <li><strong>ARK Genesis Ascended Part 1 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with ARK Genesis Ascended Part 1 Wiki.
            </p>
            ...
            <p>
              ...
              ARK Genesis Ascended Part 1 Wiki<br />
              Email: <a href="mailto:dmca@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@arkgenesisascendedpart1.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "ARK Genesis Ascended Part 1 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: ARK Genesis Ascended Part 1 Wiki (arkgenesisascendedpart1.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@arkgenesisascendedpart1.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@arkgenesisascendedpart1.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@arkgenesisascendedpart1.wiki</a>
            </p>
            <p>
